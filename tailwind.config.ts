  ...
  theme: {
    ...
    extend: {
      fontFamily: {
        ...
        editorial: ["'Fraunces'", "'Noto Sans KR'", "serif"],
      },
      fontSize: {
        h1: ["34px", { lineHeight: "42px", fontWeight: "700" }],
        h2: ["26px", { lineHeight: "34px", fontWeight: "700" }],
        h3: ["21px", { lineHeight: "30px", fontWeight: "700" }],
        title: ["18px", { lineHeight: "28px", fontWeight: "700" }],
        body: ["16px", { lineHeight: "30px", fontWeight: "400" }],
        "body-strong": ["16px", { lineHeight: "30px", fontWeight: "600" }],
        caption: ["14px", { lineHeight: "24px", fontWeight: "500" }],
      ...
      boxShadow: {
        sm: "0 8px 24px rgba(5,8,20,0.35)",
        md: "0 14px 40px rgba(5,8,20,0.42)",
        lg: "0 24px 64px rgba(5,8,20,0.52)",
      },
      zIndex: {
        sticky: "10",
        gnb: "20",
